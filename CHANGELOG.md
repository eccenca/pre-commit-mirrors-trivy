...
### Changed
- Updated Trivy binary from v0.73.0 to v0.74.0
- Updated all platform binary checksums

## [0.73.0.1] - 2026-08-13

### Changed
- Updated Trivy binary from v0.71.2 to v0.73.0
- Updated all platform binary checksums
- Updated pre-commit usage example in README.md to this repository and the current tag
